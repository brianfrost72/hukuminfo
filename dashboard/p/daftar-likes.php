...
<head>
    ...
    <title>Daftar Likes - Konig Guard Bureau</title>
                    ...
                    <div class="flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">Daftar Likes</li>
                            </ol>
                        </nav>
                        <h1 class="m-0">Daftar Likes</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="container page__container">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Daftar Likes</h4>
                    </div>
                                    ...
                                    <?php if (!empty($likes)): ?>
                                        ...
                                        <?php foreach ($likes as $row): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?= date('d F Y H:i', strtotime($row['liked_date'])); ?> WIB
                                                </td>
