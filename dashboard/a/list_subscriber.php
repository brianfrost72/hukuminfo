...
<head>
    ...
    <title>List Subscriber - Dashboard | Hukuminfo.id</title>
        ...
        <div class="mdk-header-layout__content page">
                ...
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex align-items-end">
                        <div class="flex">
                            ...
                            <h1 class="m-0">List Subscriber</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid page__container">
                <div class="container my-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title">Manage User : <span class="badge bg-success">Aktif</span></h4>
                        </div>
                ...
                <div class="container mt-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title">Manage User : <span class="badge bg-danger">Tidak Aktif</span></h4>
                        </div>
