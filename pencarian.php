...
<head>
    <meta charset="utf-8">
    <title>Pencarian: - Hukuminfo.id</title>
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="wrap__search-result">
                        <div class="wrap__search-result-keyword">
                            <h5>
                                ...
                                <span class="text-primary"> "corona virus" </span> found in 6
                                posts.
                            </h5>
                        </div>
                        ...
                        <!-- Post Article List -->
                        <div
                            class="card__post card__post-list card__post__transition mt-30">
                            <div class="row">
                                <div class="col-md-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="pagination-area">
                            <div
                                class="pagination wow fadeIn animated"
