...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .wrap__article-detail-info .d-flex {
                    ...
                    <div class="wrap__article-detail">
                        ...
                        <div class="wrap__article-detail-info">
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <span>by</span>
                                        <a href="redaksi.php" class="text-primary text-capitalize">
                                            john doe,
                                        </a>
                                    </li>
                                ...
                                <div class="article-actions">
                                    ...
                                    <a href="#" class="action-btn" title="Bookmark Artikel">
                                        <i class="fa fa-bookmark"></i>
                                        <strong>128</strong>
                                    </a>

                                    <a href="#" class="action-btn" title="Like Artikel">
                        ...
                        <div class="wrap__article-detail-content">
                            ...
                            <p class="has-drop-cap-fluid">
                                ...
                                devious Semikoli, but the Little Blind Text didn’t listen. On her way she met a copy. The copy warned the
                                Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that
                                was left from its origin would be the word “and” and the Little Blind Text should turn around and return to
